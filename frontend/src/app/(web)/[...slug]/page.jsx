...
/**
 * Custom pages, written in Admin → Pages and served from the site root.
 *
 * /maldives/kaafu-atoll/huraa-guide rather than /pages/maldives/... — the
 * segments are joined back into the single string the database indexes, so
 * nesting needs no extra routes and no extra tables.
 *
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "article",
      url: `${SITE_URL.replace(/\/$/, "")}/${page.slug}`,
      images: [image],
    },
