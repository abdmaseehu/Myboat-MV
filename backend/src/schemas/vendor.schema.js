...
const vendorSchema = z.object({
  ...
  rating: z.coerce.number().min(0).max(5).default(5).optional(),
  agentCommission: z.coerce.number().min(0).max(100).default(5).optional(),
  adminCommission: z.coerce.number().min(0).max(100).default(10).optional(),
